...
class YAPLListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by YAPLParser#DeclarationFeature.
    def enterDeclarationFeature(self, ctx:YAPLParser.DeclarationFeatureContext):
        pass

    # Exit a parse tree produced by YAPLParser#DeclarationFeature.
    def exitDeclarationFeature(self, ctx:YAPLParser.DeclarationFeatureContext):
        pass
